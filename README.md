...
<!-- card-support:start -->
Council4 currently supports **18,196 of 32,508 cards eligible for paper support (56.0%)**. The Scryfall Oracle Cards corpus contains 6,108 additional digital, special-format, memorabilia, or non-sanctioned-paper records that are excluded from that total. See [`supported.md`](./supported.md) and [`unsupported.md`](./unsupported.md) for the complete lists, and [`unsupported-reasons.md`](./unsupported-reasons.md) for capability-aware blocker planning.
<!-- card-support:end -->
