...
// VitasporeThallid is the card definition for Vitaspore Thallid.
//
...
var VitasporeThallid = newVitasporeThallid

func newVitasporeThallid() *game.CardDef {
	return &game.CardDef{
		...
		CardFace: game.CardFace{
			...
			ActivatedAbilities: []game.ActivatedAbility{
						...
						Sequence: []game.Instruction{
							{
								Primitive: game.CreateToken{
									Amount: game.Fixed(1),
									Source: game.TokenDef(vitasporeThallidToken),
								},
							},
						},
					}.Ability(),
				...
				game.ActivatedAbility{
					Text: "Sacrifice a Saproling: Target creature gains haste until end of turn.",
					AdditionalCosts: []cost.Additional{
						{
...
var vitasporeThallidToken = newVitasporeThallidToken()

func newVitasporeThallidToken() *game.CardDef {
	return &game.CardDef{
		CardFace: game.CardFace{
			Name:      "Saproling",
			Colors:    []color.Color{color.Green},
