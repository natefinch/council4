...
// HickoryWoodlot is the card definition for Hickory Woodlot.
//
// Type: Land
//
// Oracle text:
...
var HickoryWoodlot = newHickoryWoodlot()

func newHickoryWoodlot() *game.CardDef {
	return &game.CardDef{
		...
		CardFace: game.CardFace{
			...
			ActivatedAbilities: []game.ActivatedAbility{
				game.ActivatedAbility{
					Text: "{T}, Remove a depletion counter from this land: Add {G}{G}. If there are no depletion counters on this land, sacrifice it.",
