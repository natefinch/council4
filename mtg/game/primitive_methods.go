...
// Kind implements Primitive for ChampionExile.
func (ChampionExile) Kind() PrimitiveKind { return PrimitiveChampionExile }
...
// Kind implements Primitive for ExileLibraryUntilNonlandCast.
func (ExileLibraryUntilNonlandCast) Kind() PrimitiveKind {
...
// Kind implements Primitive for PlayChosenExiledCard.
func (PlayChosenExiledCard) Kind() PrimitiveKind { return PrimitivePlayChosenExiledCard }
...
func (ForEachPlayer) isPrimitive()                        {}
...
func (PlayChosenExiledCard) isPrimitive()                 {}
...
func (p ChampionExile) instructionRefs() primitiveRefs {
	return primitiveRefs{publishesLinked: p.LinkedKey}
}
...
func (p ForEachPlayer) instructionRefs() primitiveRefs {
	return primitiveRefs{publishesLinked: p.LinkedKey}
}
...
func (PlayChosenExiledCard) instructionRefs() primitiveRefs { return primitiveRefs{} }
