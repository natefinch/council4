...
func fallbackChoice(request game.ChoiceRequest) []int {
	...
	case game.ChoicePayment, game.ChoiceScry, game.ChoiceSurveil, game.ChoiceZoneSelection, game.ChoiceSearch, game.ChoiceModal, game.ChoiceResolution, game.ChoiceProliferate, game.ChoicePlayer, game.ChoiceManifest:
		if len(request.Options) == 0 || request.MaxChoices == 0 {
			return nil
		}
