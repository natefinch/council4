...
// ThallidShellDweller is the card definition for Thallid Shell-Dweller.
//
						...
						Sequence: []game.Instruction{
							{
								Primitive: game.CreateToken{
									Amount: game.Fixed(1),
									Source: game.TokenDef(thallidShellDwellerToken),
								},
							},
						},
					}.Ability(),
...
var thallidShellDwellerToken = newThallidShellDwellerToken()

func newThallidShellDwellerToken() *game.CardDef {
	return &game.CardDef{
		CardFace: game.CardFace{
			Name:      "Saproling",
			Colors:    []color.Color{color.Green},
