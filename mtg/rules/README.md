...
- Effect primitive execution for drawing cards, gaining life, losing life, player damage, permanent damage, destroy, counter, exile, bounce, sacrifice, discard, tap/untap, adding/removing/moving counters, mass selector effects, token creation/investigate, supported library-to-hand search, reveal, runtime P/T modifiers, declarative runtime continuous and rule effects, condition-gated effects, scry/surveil/mill, fight, transform, phase out, emblems, proliferate, goad, prevention, regeneration, and delayed triggers. Unsupported effect primitives and unsupported variants are logged instead of silently no-oping.
