...
// PeatBog is the card definition for Peat Bog.
//
// Type: Land
//
// Oracle text:
		...
		CardFace: game.CardFace{
			...
			ActivatedAbilities: []game.ActivatedAbility{
				game.ActivatedAbility{
					Text: "{T}, Remove a depletion counter from this land: Add {B}{B}. If there are no depletion counters on this land, sacrifice it.",
