...
// TransguildPromenade is the card definition for Transguild Promenade.
//
// Type: Land
//
// Oracle text:
...
var TransguildPromenade = newTransguildPromenade

func newTransguildPromenade() *game.CardDef {
	return &game.CardDef{
