...
// RithSGrove is the card definition for Rith's Grove.
//
// Type: Land — Lair
//
// Oracle text:
...
//	{T}: Add {R}, {G}, or {W}.
var RithSGrove = newRithSGrove

func newRithSGrove() *game.CardDef {
	return &game.CardDef{
		...
		CardFace: game.CardFace{
			...
			ManaAbilities: []game.ManaAbility{
				game.TapManaChoiceAbility(mana.R, mana.G, mana.W),
			},
