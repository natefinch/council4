...
// LockedInTheCemetery is the card definition for Locked in the Cemetery.
//
			...
			TriggeredAbilities: []game.TriggeredAbility{
				game.TriggeredAbility{
					Trigger: game.TriggerCondition{
						...
						InterveningIf: "if there are five or more cards in your graveyard",
						InterveningCondition: opt.Val(game.Condition{
							Aggregates: []game.AggregateComparison{{Aggregate: game.AggregateControllerGraveyardCardCount, Op: compare.GreaterOrEqual, Value: 5}},
						}),
					},
					Content: game.Mode{
