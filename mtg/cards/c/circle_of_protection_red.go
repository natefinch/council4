...
// CircleOfProtectionRed is the card definition for Circle of Protection: Red.
//
// Type: Enchantment
// Cost: {1}{W}
//
...
var CircleOfProtectionRed = newCircleOfProtectionRed

func newCircleOfProtectionRed() *game.CardDef {
	return &game.CardDef{
