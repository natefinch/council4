...
// OtherworldlyJourney is the card definition for Otherworldly Journey.
//
// Type: Instant — Arcane
// Cost: {1}{W}
//
...
var OtherworldlyJourney = newOtherworldlyJourney

func newOtherworldlyJourney() *game.CardDef {
	return &game.CardDef{
