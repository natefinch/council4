...
// TributeMage is the card definition for Tribute Mage.
//
						...
						Sequence: []game.Instruction{
							{
								Primitive: game.Search{
									...
									Spec: game.SearchSpec{
										...
										Filter:      game.Selection{RequiredTypes: []types.Card{types.Artifact}, ManaValue: opt.Val(compare.Int{Op: compare.Equal, Value: 2})},
										Reveal:      true,
									},
									Amount: game.Fixed(1),
								},
