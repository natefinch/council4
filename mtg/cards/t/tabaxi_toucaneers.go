...
// TabaxiToucaneers is the card definition for Tabaxi Toucaneers.
//
// Type: Creature — Cat Ranger
// Cost: {4}{W}
//
// Oracle text:
//
...
var TabaxiToucaneers = newTabaxiToucaneers

func newTabaxiToucaneers() *game.CardDef {
	return &game.CardDef{
		...
		CardFace: game.CardFace{
			...
			Subtypes:  []types.Sub{types.Cat, types.Ranger},
