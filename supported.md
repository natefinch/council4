...
Council4 currently supports **17,487 of 32,501 cards eligible for paper support (53.8%)**. The Scryfall Oracle Cards corpus contains 5,725 additional digital, special-format, memorabilia, or non-sanctioned-paper records that are excluded from that total.
