	...
	for _, sentence := range sentences {
		...
		for syntaxIndex := range sentence.Effects {
			...
			effects = append(effects, CompiledEffect{
				...
				ResolvingCostModifierCaster:        syntax.ResolvingCostModifierCaster,
				ResolvingCostModifierIncrease:      syntax.ResolvingCostModifierIncrease,
				ResolvingCostModifierAmount:        syntax.ResolvingCostModifierAmount,
				ResolvingCostModifierRequiredTypes: compilerCardTypes(syntax.ResolvingCostModifierRequiredTypes),
				ResolvingCostModifierExcludedTypes: compilerCardTypes(syntax.ResolvingCostModifierExcludedTypes),
