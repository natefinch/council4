...
// BilboRetiredBurglar is the card definition for Bilbo, Retired Burglar.
//
						...
						Sequence: []game.Instruction{
							{
								Primitive: game.CreateToken{
									Amount: game.Fixed(1),
									Source: game.TokenDef(bilboRetiredBurglarToken),
								},
							},
						},
					}.Ability(),
...
var bilboRetiredBurglarToken = newBilboRetiredBurglarToken()

func newBilboRetiredBurglarToken() *game.CardDef {
	return &game.CardDef{
		CardFace: game.CardFace{
			Name:     "Treasure",
