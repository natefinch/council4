...
func TestScorableEffectClassifiesValueDominantPrimitives(t *testing.T) {
	...
	cases := []struct {
		...
		{"exile", game.MovePermanent{Destination: zone.Exile}, EffectAtom{Kind: EffectPermanentRemoved, Affected: AffectedTarget}},
		{"bounce", game.MovePermanent{Destination: zone.Hand}, EffectAtom{Kind: EffectPermanentRemoved, Affected: AffectedTarget}},
