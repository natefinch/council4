...
// MetathranTransport is the card definition for Metathran Transport.
//
...
var MetathranTransport = newMetathranTransport()

func newMetathranTransport() *game.CardDef {
	return &game.CardDef{
		...
		CardFace: game.CardFace{
			...
			Subtypes:  []types.Sub{types.Metathran},
