...
// SoratamiSavant is the card definition for Soratami Savant.
//
...
func newSoratamiSavant() *game.CardDef {
	return &game.CardDef{
		...
		CardFace: game.CardFace{
			...
			Subtypes:  []types.Sub{types.Moonfolk, types.Wizard},
			...
			ActivatedAbilities: []game.ActivatedAbility{
				game.ActivatedAbility{
					Text:     "{3}, Return a land you control to its owner's hand: Counter target spell unless its controller pays {3}.",
