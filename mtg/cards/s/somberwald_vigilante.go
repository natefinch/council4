...
// SomberwaldVigilante is the card definition for Somberwald Vigilante.
//
...
var SomberwaldVigilante = newSomberwaldVigilante

func newSomberwaldVigilante() *game.CardDef {
	return &game.CardDef{
