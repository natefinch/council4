...
func (Renderer) renderObjectReference(reference game.ObjectReference) (string, error) {
	...
	case game.ObjectReferenceCapturedObject:
		return "game.CapturedObjectReference()", nil
...
func renderAdditional(ctx *renderCtx, additional cost.Additional) (string, error) {
	...
	if (additional.Kind == cost.AdditionalRemoveCounterAmong || additional.Kind == cost.AdditionalRemoveCounter) && additional.AnyCounterKind {
...
func renderDynamicAmountKind(kind game.DynamicAmountKind) (string, error) {
	...
	case game.DynamicAmountCommanderCastCount:
		return "game.DynamicAmountCommanderCastCount", nil
	...
	case game.DynamicAmountTriggeringEventTotalPower:
		return "game.DynamicAmountTriggeringEventTotalPower", nil
	case game.DynamicAmountTriggeringEventTotalCombatDamage:
		return "game.DynamicAmountTriggeringEventTotalCombatDamage", nil
	default:
