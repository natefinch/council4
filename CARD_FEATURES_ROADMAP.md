...
- [ ] Modal variants beyond choose-one: "choose two", "choose one or both", "choose up to one", "choose three", and Entwine-style all-mode selection.
- [ ] Resolution choices inside effects: "you may...", "if you do", "if you don't", "choose a color/card/type/player", and "you may pay..." during resolution.
- [ ] Common trigger patterns beyond the initial event filters: beginning-of-step triggers, state triggers, noncreature/artifact/permanent spell casts, opponent-controlled objects, and richer negated conditions.
