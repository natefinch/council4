...
// StaunchCrewmate is the card definition for Staunch Crewmate.
//
						...
						Sequence: []game.Instruction{
							{
								Primitive: game.Dig{
									...
									Filter:    opt.Val(game.Selection{RequiredTypes: []types.Card{types.Artifact}, SubtypesAny: []types.Sub{types.Sub("Pirate")}}),
									TakeUpTo:  true,
									Reveal:    true,
								},
							},
