...
// SkyhunterCub is the card definition for Skyhunter Cub.
//
...
var SkyhunterCub = newSkyhunterCub

func newSkyhunterCub() *game.CardDef {
	return &game.CardDef{
		...
		CardFace: game.CardFace{
			...
			Subtypes:  []types.Sub{types.Cat, types.Knight},
