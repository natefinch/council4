...
// MercenaryKnight is the card definition for Mercenary Knight.
//
// Type: Creature — Human Mercenary Knight
// Cost: {2}{B}
//
// Oracle text:
//
...
func newMercenaryKnight() *game.CardDef {
	return &game.CardDef{
		...
		CardFace: game.CardFace{
			...
			Subtypes:  []types.Sub{types.Human, types.Mercenary, types.Knight},
						...
						Sequence: []game.Instruction{
							{
								Primitive: game.Pay{
									Payment: game.ResolutionPayment{
										Prompt: "Discard a creature card?",
