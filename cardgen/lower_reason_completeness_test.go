...
// supported: Barroom Brawl is blocked by both an optional effect and an
// unsupported ordered sequence (its two-target directional fight base is
// unsupported), and both must be reported so support planning does not overcount
// how many cards supporting optional effects alone would unblock.
func TestOptionalProbeSurfacesInnerBlocker(t *testing.T) {
	...
	_, diagnostics := lowerExecutableFaces(&ScryfallCard{
		...
		Layout:     "normal",
		TypeLine:   "Sorcery",
		OracleText: "Target creature you control fights target creature the opponent to your left controls. Then that player may copy this spell and may choose new targets for the copy.",
	})
