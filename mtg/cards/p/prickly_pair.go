...
// PricklyPair is the card definition for Prickly Pair.
//
...
var PricklyPair = newPricklyPair()

func newPricklyPair() *game.CardDef {
	return &game.CardDef{
						...
						Sequence: []game.Instruction{
							{
								Primitive: game.CreateToken{
									Amount: game.Fixed(1),
									Source: game.TokenDef(pricklyPairToken),
								},
							},
						},
					}.Ability(),
...
var pricklyPairToken = newPricklyPairToken()

func newPricklyPairToken() *game.CardDef {
	return &game.CardDef{
		CardFace: game.CardFace{
			Name:      "Mercenary",
			Colors:    []color.Color{color.Red},
