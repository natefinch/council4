...
// TreasureMage is the card definition for Treasure Mage.
//
						...
						Sequence: []game.Instruction{
							{
								Primitive: game.Search{
									...
									Spec: game.SearchSpec{
										...
										Filter:      game.Selection{RequiredTypes: []types.Card{types.Artifact}, ManaValue: opt.Val(compare.Int{Op: compare.GreaterOrEqual, Value: 6})},
										Reveal:      true,
									},
									Amount: game.Fixed(1),
								},
