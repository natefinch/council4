...
// DeathsporeThallid is the card definition for Deathspore Thallid.
//
...
var DeathsporeThallid = newDeathsporeThallid

func newDeathsporeThallid() *game.CardDef {
	return &game.CardDef{
		...
		CardFace: game.CardFace{
			...
			Subtypes:  []types.Sub{types.Zombie, types.Fungus},
						...
						Sequence: []game.Instruction{
							{
								Primitive: game.CreateToken{
									Amount: game.Fixed(1),
									Source: game.TokenDef(deathsporeThallidToken),
								},
							},
						},
					}.Ability(),
...
var deathsporeThallidToken = newDeathsporeThallidToken()

func newDeathsporeThallidToken() *game.CardDef {
	return &game.CardDef{
		CardFace: game.CardFace{
			Name:      "Saproling",
