...
// Everglades is the card definition for Everglades.
//
// Type: Land
//
// Oracle text:
...
//	{T}: Add {C}{B}.
var Everglades = newEverglades()

func newEverglades() *game.CardDef {
	return &game.CardDef{
						...
						Sequence: []game.Instruction{
							{
								Primitive: game.Pay{
									Payment: game.ResolutionPayment{
										Prompt: "Return an untapped Swamp you control to its owner's hand?",
										AdditionalCosts: []cost.Additional{
											{
												Kind:            cost.AdditionalReturnToHand,
												Text:            "return an untapped Swamp you control to its owner's hand",
												Amount:          1,
