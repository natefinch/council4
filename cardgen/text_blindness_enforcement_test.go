...
// it). The remaining rendering entries cover cosmetic cost.Additional.Text;
// runtime behavior is carried by typed fields such as SourceSelf. Nothing here
// derives game meaning from Oracle wording.
var loweringTextUseAllowlist = []allowedTextUse{
	...
	},
	{
		...
		Category: "rendering",
		Justification: "Empty-checks the cosmetic additional-cost Text before emitting it for generated " +
			"source readability. Typed cost fields carry all runtime behavior.",
	},
	{
		File:     "render_cost.go",
