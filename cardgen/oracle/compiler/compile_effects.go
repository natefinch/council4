	...
	for _, sentence := range sentences {
		...
		for syntaxIndex := range sentence.Effects {
			...
			effects = append(effects, CompiledEffect{
				...
				TokenAttackDefender:                syntax.AttackDefender,
				TokenCount:                         compileTypedAmount(syntax.TokenCount),
				...
				DelayedTriggerBindEventPlayer:      syntax.DelayedTriggerBindEventPlayer,
				...
				TokenCopyHalveRoundUpRiderSpan:     syntax.TokenCopyHalveRoundUpRiderSpan,
				TokenCopyOfAttached:                syntax.TokenCopyOfAttached,
				TokenCopyOfTriggeringSet:           syntax.TokenCopyOfTriggeringSet,
				TokenCopyOfChosenSaddleContributor: syntax.TokenCopyOfChosenSaddleContributor,
				...
				EntersAttacking:               syntax.EntersAttacking,
				...
				BecomeTypeAddSubtypes:    slices.Clone(syntax.BecomeTypeAddSubtypes),
				BecomeTypeUntilEndOfTurn: syntax.BecomeTypeUntilEndOfTurn,

				BecomeColorColors:         polymorphColors(syntax.BecomeColorColors),
				BecomeColorColorless:      syntax.BecomeColorColorless,
				BecomeColorSource:         syntax.BecomeColorSource,
				BecomeColorUntilEndOfTurn: syntax.BecomeColorUntilEndOfTurn,

				PolymorphColors:            polymorphColors(syntax.PolymorphColors),
				PolymorphColorless:         syntax.PolymorphColorless,
				PolymorphTypes:             slices.Clone(syntax.PolymorphTypes),
				...
				PolymorphLosesAllAbilities: syntax.PolymorphLosesAllAbilities,
				...
				CopyLinkedExiledCard:           syntax.CopyLinkedExiledCard,
				...
				Mana: CompiledEffectMana{
					...
					ChosenColorCount:         syntax.Mana.ChosenColorCount,
					...
					ChosenColorAnaphor:       syntax.Mana.ChosenColorAnaphor,
					...
					Combination:              syntax.Mana.Combination,
					CombinationColors:        slices.Clone(syntax.Mana.CombinationColors),
					CombinationCount:         syntax.Mana.CombinationCount,
					CombinationDynamic:       syntax.Mana.CombinationDynamic,
					PersistUntilEndOfTurn:    syntax.Mana.PersistUntilEndOfTurn,
				},
				...
				IterativeLibraryReveal:                        syntax.IterativeLibraryReveal,
				IterativeLibraryOptionalTake:                  syntax.IterativeLibraryOptionalTake,
				IterativeLibraryPreExile:                      syntax.IterativeLibraryPreExile,
				IterativeLibraryPreludeSpan:                   syntax.IterativeLibraryPreludeSpan,
				TibaltsTrickery:                               syntax.TibaltsTrickery,
				...
				ShuffleControllerHandAndGraveyardIntoLibrary:  syntax.ShuffleControllerHandAndGraveyardIntoLibrary,
				ExileSourceSpell:                              syntax.ExileSourceSpell,
				...
				DistributiveRemoval:                           syntax.DistributiveRemoval,
				ExileEachOpponentChoosesGreatestPower:         syntax.ExileEachOpponentChoosesGreatestPower,
				DrawForEachExiledThisWay:                      syntax.DrawForEachExiledThisWay,
				DamageEachOpponentCorrelatedExiledPower:       syntax.DamageEachOpponentCorrelatedExiledPower,
				CloakForEachExiledThisWay:                     syntax.CloakForEachExiledThisWay,
				...
				UntapAttackedThisTurn:                         syntax.UntapAttackedThisTurn,
				...
				AdditionalCombatPhaseCount:                    syntax.AdditionalCombatPhaseCount,
...
func effectKindForStaticRule(rule StaticRuleKind) EffectKind {
	...
	case StaticRuleCantAttackOrBlockAndCantActivate:
		return EffectCantAttackOrBlockAndCantActivate
	case StaticRuleCantAttackOrBlockAndCantActivateNonMana:
		return EffectCantAttackOrBlockAndCantActivateNonMana
