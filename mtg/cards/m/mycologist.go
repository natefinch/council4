...
// Mycologist is the card definition for Mycologist.
//
...
var Mycologist = newMycologist()

func newMycologist() *game.CardDef {
	return &game.CardDef{
						...
						Sequence: []game.Instruction{
							{
								Primitive: game.CreateToken{
									Amount: game.Fixed(1),
									Source: game.TokenDef(mycologistToken),
								},
							},
						},
					}.Ability(),
...
var mycologistToken = newMycologistToken()

func newMycologistToken() *game.CardDef {
	return &game.CardDef{
		CardFace: game.CardFace{
			Name:      "Saproling",
