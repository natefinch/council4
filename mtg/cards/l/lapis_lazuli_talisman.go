...
// LapisLazuliTalisman is the card definition for Lapis Lazuli Talisman.
//
// Type: Artifact
// Cost: {2}
//
...
var LapisLazuliTalisman = newLapisLazuliTalisman

func newLapisLazuliTalisman() *game.CardDef {
	return &game.CardDef{
