...
Council4 currently supports **18,100 of 32,502 cards eligible for paper support (55.7%)**. The Scryfall Oracle Cards corpus contains 5,752 additional digital, special-format, memorabilia, or non-sanctioned-paper records that are excluded from that total.
