...
// RiveteersOverlook is the card definition for Riveteers Overlook.
//
// Type: Land
//
// Oracle text:
							...
							},
							{
								Primitive: game.Search{
									...
									Spec: game.SearchSpec{
										...
										Filter:       game.Selection{Supertypes: []types.Super{types.Basic}, SubtypesAny: []types.Sub{types.Sub("Swamp"), types.Sub("Mountain"), types.Sub("Forest")}},
										EntersTapped: true,
									},
									Amount: game.Fixed(1),
								},
