...
// DormantVolcano is the card definition for Dormant Volcano.
//
// Type: Land
//
// Oracle text:
						...
						Sequence: []game.Instruction{
							{
								Primitive: game.Pay{
									Payment: game.ResolutionPayment{
										Prompt: "Return an untapped Mountain you control to its owner's hand?",
										AdditionalCosts: []cost.Additional{
											{
												Kind:            cost.AdditionalReturnToHand,
												Text:            "return an untapped Mountain you control to its owner's hand",
												Amount:          1,
