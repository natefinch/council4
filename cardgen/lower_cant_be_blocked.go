...
// turn."), the source itself ("This creature can't be blocked this turn."), and
// a prior-subject sequence clause that inherits the source as its subject ("...
// and can't be blocked this turn."). Every other recipient, duration, condition,
// mode, or reference fails closed so the broader "can't be blocked this turn"
// family stays faithful and bounded.
