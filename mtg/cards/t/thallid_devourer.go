...
// ThallidDevourer is the card definition for Thallid Devourer.
//
	...
	return &game.CardDef{
		...
		CardFace: game.CardFace{
			...
			ActivatedAbilities: []game.ActivatedAbility{
						...
						Sequence: []game.Instruction{
							{
								Primitive: game.CreateToken{
									Amount: game.Fixed(1),
									Source: game.TokenDef(thallidDevourerToken),
								},
							},
						},
					}.Ability(),
				...
				game.ActivatedAbility{
					Text: "Sacrifice a Saproling: This creature gets +1/+2 until end of turn.",
					AdditionalCosts: []cost.Additional{
						{
...
var thallidDevourerToken = newThallidDevourerToken()

func newThallidDevourerToken() *game.CardDef {
	return &game.CardDef{
		CardFace: game.CardFace{
			Name:      "Saproling",
			Colors:    []color.Color{color.Green},
